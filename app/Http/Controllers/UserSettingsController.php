 ...
 */
    public function updateProfile(Request $request) {
        ...
        $validator = Validator::make($request->all(), [
            ...
            'number' => ['regex:/(09)[0-9]{9}/', 'nullable', 'max:11', 'min:11'],
            'edod' => ['date', 'nullable'],
            ...
            'number.max' => 'Contact number field may not be greater than 11 characters.',
            'number.min' => 'Contact number field may not be lesser than 11 characters.',
            'number.regex' => 'The contact number format is invalid',
